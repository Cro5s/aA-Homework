...
describe Dessert do
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect { Dessert.new("bownie", "5", chef) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["sugar", "chocolate_mix", "eggs", "milk"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Ratatouille the Great Baker")
      expect(brownie.serve).to eq("Chef Ratatouille the Great Baker has made 5 brownies!")
    end
  end
